...
if (isset($_POST["recalc"])){
	$f1=$_POST["f1"];
	$f2=$_POST["f2"];
	$q="update claveValor set valor='$f1' where clave='rProdf1'"; // registra fechas 
	$db->query($q);
	$q="update claveValor set valor='$f2' where clave='rProdf2'"; 
	$db->query($q);
/*
...
$_SESSION["msg"]="Periodo de producción actualizado";
